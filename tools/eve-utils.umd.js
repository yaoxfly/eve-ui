(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["eve-utils"] = factory();
	else
		root["eve-utils"] = factory();
...
var idCheck = function idCheck(idcard) {
  ...
  var Y, JYM;
  var S, M;
  var idcardArray = idcard.split(''); // 身份号码位数及格式检验
...
var checkSHXYDM = function checkSHXYDM(val) {
  var errorMsg = '请输入正确的统一社会信用代码！';

  if (!val) {
    return '';
  }

  var Code = val.toString(); // 验证第一位
